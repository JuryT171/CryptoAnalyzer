...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            try {  //  вводим исключение
                System.out.println(ANSWERING + studentsJournal.get(studentId));  //  отвечает студен
            } catch (ArrayIndexOutOfBoundsException e){  //  если введен некорректный индекс  --->
                System.out.println(NOT_EXIST);  // ----> выводим это сообщение
            }
        }
    }
}
