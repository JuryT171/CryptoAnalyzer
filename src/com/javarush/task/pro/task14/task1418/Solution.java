...
public class Solution {
    ...
    public static int getChildrenCount(Human human) {
        ...
        try {
            size = human.getChildren().size();  //  код где может быть ошибка
        } catch (NullPointerException e) {  //  ловим ошибку
            throw new ChildrenNotInitializedException(message);  //  выбрасываем свое исключение с сообщением
        }
