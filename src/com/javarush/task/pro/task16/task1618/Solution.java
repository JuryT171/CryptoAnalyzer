...
public class Solution {
    ...
    static LocalDateTime changeZone(LocalDateTime fromDateTime, ZoneId fromZone, ZoneId toZone) {
        ...
        ZonedDateTime result = ZonedDateTime.of(fromDateTime, fromZone);  //  получаем время с известным временем и зоной
        return result.withZoneSameInstant(toZone).toLocalDateTime();  //  получаем то же время в другой зоне
    }
}
