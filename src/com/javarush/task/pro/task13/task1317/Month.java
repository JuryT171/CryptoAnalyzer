...
//  переменные месяцев
  ...
  public static final Month DECEMBER = new Month(11);
    //  массив который хранит переменные
    ...
    private Month (int value)   //   переменная конкретного месяца
    {
        this.value = value;
    }

    public int ordinal()   //  метод ординал вызываем у конкретного объекта
    {
        return this.value;  //  возвращает значение обьекта
    }

    public static Month[] values()   //  возвращает массив со всеми значениями
    {
        return array;
    }
}
